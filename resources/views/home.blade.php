...
<body class="bg-black text-gold-light min-h-screen flex items-center justify-center p-4">
        ...
        <form id="testForm" method="GET" class="space-y-8">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <!-- Qoʻl bilan qoʻshilgan sinov test -->
                    {{-- <button type="button"
            ...
            <!-- Hidden input -->
            <input type="hidden" name="test_name_id" id="categoryInput" required>
    ...
    <script>
        ...
        document.getElementById('testForm').addEventListener('submit', function(e) {
            ...
            if (!rangeMin || !rangeMax || !categoryId) {
            ...
            let url = `/questions?start_number=${rangeMin}&end_number=${rangeMax}&test_name_id=${categoryId}`;
            if (chatId) {
                url += `&chat_id=${chatId}`;
            }
